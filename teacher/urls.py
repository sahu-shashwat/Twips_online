...
from teacher.views import teacher_view,teacher_otp_view,teacher_login_view,teacher_home_view,teacher_logout_view,register_course,register_domain,update_course,update_domain,delete_course,delete_domain,list_course,register_video,update_video,delete_video,list_video
...
urlpatterns = [
    ...
    path(route='list_video/',view=list_video,name='list_video'),
]
